...
<p> The future of anthropogenic fossil fuel use depends on human decisions about energy use at scales from local to global. If we do not change our historical pattern of fossil fuel dependency, emissions will continue to increase. If we acknowledge how serious the climate crisis is, we have the knowledge and technologies needed to change these patterns so as to cut emissions rapidly. This will require transforming energy systems to be dominated by renewables, changing food systems to be more efficient and less carbon intensive, and modifying transportation patterns and infrastructure to use far less energy. If we do these things, we can reduce emissions and thus reduce the damages and suffering that we and our children will experience due to climate change. To reform our fossil fuel-based economies will entail difficult political and social decisions from the local to the global scale. But this is not an impossible problem if everyone contributes to our low carbon future.  </p>
