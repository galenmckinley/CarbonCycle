...
<p>
If not for the ocean, the atmospheric concentration of CO2 would be 96ppm higher than at present (equivalent to 200 PgC). Of all fossil fuel emissions to the atmosphere (495 PgC) since 1850, the ocean has cumulatively mitigated 40% and the rest has remained in the atmosphere (Friedlingstein et al. 2026). If we take anthropogenic emissions to be the sum of fossil fuel (495 PgC) and land use change emissions (250 PgC), the ocean has cumulatively removed 27% from the atmosphere. Here is an animation of the changing balance of carbon sources and sinks since 1850. </p>
