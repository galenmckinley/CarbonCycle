...
<p>
One way scientists learn about how the ocean carbon sink can change is by studying variability in recent decades (Gruber et al. 2023). Observational studies of the Southern Ocean have found that the ocean carbon sink weakened in the decade of the 1990s, and then strengthened again. Though many have tried, these Southern Ocean changes have yet to be satisfactorily explained. Increasing the quantity of observations will likely be critical solving this puzzle (Bakker et al. 2016, Gloege et al. 2021, Heimdal et al. 2023). </p>
