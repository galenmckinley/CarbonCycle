...
<p>
Scientists can better understand how the ocean carbon sink changes by studying its recent variability (Gruber et al. 2023). In the Southern Ocean, observational studies suggest the sink weakened over the 1990s, and then strengthened again. Though many have tried, these changes have yet to be satisfactorily explained. Increasing the quantity of surface ocean carbon observations will likely be critical to solving this puzzle (Bakker et al. 2016, Gloege et al. 2021, Heimdal et al. 2023). </p>
